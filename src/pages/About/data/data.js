export const features = [
    {
        ...
        details: {
            imageUrl: "src/assets/1.png" || "@/assets/1.png",
    ...
    },
    {
        ...
        details: {
            imageUrl: "src/assets/2.png" || "@/assets/2.png" ,
    ...
    },
    {
        ...
        details: {
            imageUrl: "src/assets/illustration-features-tab-3.svg" || "@/assets/illustration-features-tab-3.svg",
...
export const downloads = [
    {
        id: 1,
        icon: "https://img.icons8.com/hands/100/experimental-thumb-up-hands.png",
        // icon: "src/assets/fb-logo.svg",
        title: "Efficacité",
        subTitle: "Maintenir des normes élevées ",
        link: "#",
    },
    {
        id: 2,
        icon: "https://img.icons8.com/hands/100/experimental-ok-hand-hands.png",
        // icon: "src/assets/insta-logo.svg",
        title: "Excellence",
        subTitle: "Surpasser les attentes",
        link: "#",
    },
    {
        id: 3,
        icon: "https://img.icons8.com/hands/100/experimental-coffee-hands.png",
        // icon: "src/assets/twit-logo.svg",
        title: "Collaboration",
        subTitle: "Atteindre nos objectifs communs",
        link: "#",
    },
];
